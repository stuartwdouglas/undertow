...
public abstract class AbstractServerConnection  extends ServerConnection {
     ...
     */
    protected PooledBuffer extraBytes;
    ...
    public PooledBuffer getExtraBytes() {
        if(extraBytes != null && !extraBytes.buffer().hasRemaining()) {
            extraBytes.close();
            extraBytes = null;
            return null;
        }
    ...
    public void setExtraBytes(final PooledBuffer extraBytes) {

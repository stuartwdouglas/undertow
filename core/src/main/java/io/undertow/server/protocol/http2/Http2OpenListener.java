    ...
    public void handleEvent(final StreamConnection channel) {
        ...
        if (existing != null) {
            ...
            if (existing.equals(HTTP2)) {
                Http2Channel sc = new Http2Channel(channel, bufferPool, new ImmediatePooled<>(ByteBuffer.wrap(new byte[0])), false);
            ...
            try {
                while (true) {
                    ...
                    if (HTTP2.equals(selected)) {
                        ...
                        Http2Channel channel = new Http2Channel(this.channel, bufferPool, buffer, false);

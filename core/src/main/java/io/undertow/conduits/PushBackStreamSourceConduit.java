...
public final class PushBackStreamSourceConduit extends AbstractStreamSourceConduit<StreamSourceConduit> implements StreamSourceConduit {
     ...
     */
    public void pushBack(PooledBuffer pooledBuffer) {
        if (pooledBuffer == null) {
            return;
        }
        if (shutdown || ! pooledBuffer.buffer().hasRemaining()) {
            pooledBuffer.close();
        } else {
    ...
    class BufferConduit extends AbstractStreamSourceConduit<StreamSourceConduit> implements StreamSourceConduit {
        ...
        BufferConduit(final StreamSourceConduit next, final PooledBuffer pooledBuffer) {
            super(next);
        ...
        public int read(final ByteBuffer dst) throws IOException {
            ...
            try {
                final ByteBuffer src = pooledBuffer.buffer();

 ...
 */
public final class ClientFixedLengthStreamSourceConduit extends AbstractStreamSourceConduit<StreamSourceConduit> {

    private final ConduitListener<? super ClientFixedLengthStreamSourceConduit> finishListener;
     ...
     */
    public ClientFixedLengthStreamSourceConduit(final StreamSourceConduit next, final long contentLength, final ConduitListener<? super ClientFixedLengthStreamSourceConduit> finishListener) {
        super(next);

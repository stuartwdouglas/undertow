 ...
 */
public final class ParameterValues extends AbstractCollection<String> implements Deque<String>, List<String>, RandomAccess {
    ...
    ParameterValues(final String key) {
        this.key = key;
    }
    ...
    private ListIterator<String> iterator(final int start, final boolean forwards) {
        return new ListIterator<String>() {
            ...
            public void remove() {
                ...
                ParameterValues.this.remove(returned);
                returned = -1;
            }
            ...
            public void set(final String headerValue) {
                ...
                ParameterValues.this.set(returned, headerValue);
            }
            ...
            public void add(final String headerValue) {
                ...
                ParameterValues.this.add(idx, headerValue);
                this.idx = idx + 1;
                returned = -1;
            }
        };

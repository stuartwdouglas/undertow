...
public abstract class WebSocketChannel extends AbstractFramedChannel<WebSocketChannel, StreamSourceFrameChannel, StreamSinkFrameChannel> {
     ...
     */
    protected WebSocketChannel(final StreamConnection connectedStreamChannel, ByteBufferPool bufferPool, WebSocketVersion version, String wsUrl, String subProtocol, final boolean client, boolean extensionsSupported, final List<ExtensionFunction> extensions, Set<WebSocketChannel> peerConnections) {
    ...
    @Override
    protected StreamSourceFrameChannel createChannel(FrameHeaderData frameHeaderData, PooledBuffer frameData) {
    ...
    public interface PartialFrame extends FrameHeaderData {
         ...
         */
        StreamSourceFrameChannel getChannel(final PooledBuffer data);

...
class WebSocket07CloseFrameSourceChannel extends StreamSourceFrameChannel {
    ...
    WebSocket07CloseFrameSourceChannel(WebSocket07Channel wsChannel, int rsv, Masker masker, PooledBuffer pooled, long frameLength) {
    ...
    WebSocket07CloseFrameSourceChannel(WebSocket07Channel wsChannel, int rsv, PooledBuffer pooled, long frameLength) {
        // no fragmentation allowed per spec

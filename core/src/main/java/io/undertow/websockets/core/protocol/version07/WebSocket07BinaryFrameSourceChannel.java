...
class WebSocket07BinaryFrameSourceChannel extends StreamSourceFrameChannel {
    WebSocket07BinaryFrameSourceChannel(WebSocketChannel wsChannel, int rsv, boolean finalFragment, Masker masker, PooledBuffer pooled, long frameLength) {
        super(wsChannel, WebSocketFrameType.BINARY, rsv, finalFragment, pooled, frameLength, masker);
    }

    WebSocket07BinaryFrameSourceChannel(WebSocketChannel wsChannel, int rsv, boolean finalFragment, PooledBuffer pooled, long frameLength) {

...
public class Http2ClientProvider implements ClientProvider {
    ...
    private static Http2ClientConnection createSpdyChannel(StreamConnection connection, Pool<ByteBuffer> bufferPool) {
        Http2Channel http2Channel = new Http2Channel(connection, bufferPool, null, true);
        return new Http2ClientConnection(http2Channel);
    }

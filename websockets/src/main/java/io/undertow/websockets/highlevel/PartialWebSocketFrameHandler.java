...
/**
 * Well get notified about parts of a WebSocket frame. And so can be used to received notifications about it as soon
 * as possible without the need to buffer the whole frame.
 *

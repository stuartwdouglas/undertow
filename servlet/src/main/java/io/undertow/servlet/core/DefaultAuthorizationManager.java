...
public class DefaultAuthorizationManager implements AuthorizationManager {
    ...
    @Override
    public boolean isAuthenticationRequired(List<SingleConstraintMatch> mappedConstraints, ServletInfo servletInfo, HttpServletRequest request, Deployment deployment) {
        ...
        for (SingleConstraintMatch constraint : mappedConstraints) {
            if (constraint.getRequiredRoles().isEmpty()) {
                if (constraint.getEmptyRoleSemantic() == SecurityInfo.EmptyRoleSemantic.DENY) {
                     ...
                     */
                    return false;
                } else if (constraint.getEmptyRoleSemantic() == SecurityInfo.EmptyRoleSemantic.AUTHENTICATE) {

    ...
    public void run() {
        ...
        try {
            ...
            OptionMap serverOptions = OptionMap.builder()
                    ...
                    .getMap();
            HttpOpenListener openListener = new HttpOpenListener(new DefaultByteBufferPool(true, 8192, 100, 10));
           ...
           AcceptingChannel<StreamConnection> server = worker.createStreamConnectionServer(new InetSocketAddress(port), acceptListener, serverOptions);
            ...
            ServerWebSocketContainer deployment = new ServerWebSocketContainer(TestClassIntrospector.INSTANCE, worker, new DefaultByteBufferPool(true, 8192, 100, 10),new CompositeThreadSetupAction(Collections.EMPTY_LIST), true, false);

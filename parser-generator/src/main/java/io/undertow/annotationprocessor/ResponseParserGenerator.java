...
public class ResponseParserGenerator extends AbstractParserGenerator {
    ...
    //class names
    public static final String PARSE_STATE_CLASS = "io.undertow.connector.xnio.client.http.ResponseParseState";
    public static final String HTTP_RESPONSE_CLASS = "io.undertow.connector.xnio.client.http.HttpResponseBuilder";

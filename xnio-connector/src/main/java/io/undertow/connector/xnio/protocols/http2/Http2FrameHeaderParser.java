...
package io.undertow.connector.xnio.protocols.http2;

import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_CONTINUATION;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_DATA;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_GOAWAY;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_HEADERS;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_PRIORITY;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_PUSH_PROMISE;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_RST_STREAM;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_SETTINGS;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.FRAME_TYPE_WINDOW_UPDATE;
import static io.undertow.connector.xnio.protocols.http2.Http2Channel.HEADERS_FLAG_END_HEADERS;

...
public class Http2PushPromiseStreamSourceChannel extends AbstractHttp2StreamSourceChannel {
    ...
    Http2PushPromiseStreamSourceChannel(Http2Channel framedChannel, PooledBuffer data, long frameDataRemaining, HeaderMap headers, int pushedStreamId, int associatedStreamId) {
